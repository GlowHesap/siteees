...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.18.0, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    ...
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-cd41">
  <div class="u-clearfix u-sheet u-valign-top u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/200331154_499523377799311_3654758073717377301_n.jpg",
            'default_url' => home_url('/'),
            'default_width' => '122'
        )); ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo esc_url($logo['url']); ?>" class="u-file-link u-image u-logo u-image-1 custom-logo-link" data-image-width="150" data-image-height="150" title="Tercih" target="_blank">
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="122">
    </a>
    <?php
            ob_start();
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-022e-21',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-022e-22',
                    'submenu_item_class' => 'u-nav-item',
